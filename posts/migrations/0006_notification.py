...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('posts', '0005_remove_follow_is_following'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_type', models.CharField(choices=[('like', 'New Like'), ('post', 'New Post'), ('follow', 'New Follow'), ('comment', 'New Comment'), ('blocked', 'Post Blocked'), ('unblocked', 'Post Unblocked')], max_length=20)),
